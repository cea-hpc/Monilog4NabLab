...
class NablabLaunchConstants {
	package static val LAUNCH_CONFIGURATION_TYPE_ID = 'fr.cea.nabla.ui.graalvm.launchconfig.NablabLaunchConfigurationType'
	...
	package static def getProject(ILaunchConfiguration configuration) {
		val projectName = configuration.getAttribute(NablabLaunchConstants::PROJECT, '')
